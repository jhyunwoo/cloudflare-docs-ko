...
translation_source_html: 'https://developers.cloudflare.com/r2/platform/release-notes/'
translation_source_md: 'https://developers.cloudflare.com/r2/platform/release-notes/index.md'
