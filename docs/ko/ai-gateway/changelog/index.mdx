...
translation_source_html: 'https://developers.cloudflare.com/ai-gateway/changelog/'
translation_source_md: 'https://developers.cloudflare.com/ai-gateway/changelog/index.md'
