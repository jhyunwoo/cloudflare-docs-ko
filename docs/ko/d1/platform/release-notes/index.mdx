...
translation_source_html: 'https://developers.cloudflare.com/d1/platform/release-notes/'
translation_source_md: 'https://developers.cloudflare.com/d1/platform/release-notes/index.md'
