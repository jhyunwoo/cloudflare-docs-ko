...
title: 가상 기기 구성
description: >-
  VMWare ESXi 또는 Proxmox Virtual Environment에서 Cloudflare One Virtual Appliance를
  구성하는 방법을 알아보세요.
sidebar:
  order: 4
translation_locale: ko-KR
translation_source_html: >-
  https://developers.cloudflare.com/cloudflare-wan/configuration/appliance/configure-virtual-appliance/
translation_source_md: >-
  https://developers.cloudflare.com/cloudflare-wan/configuration/appliance/configure-virtual-appliance/index.md
