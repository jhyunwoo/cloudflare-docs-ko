...
translation_source_html: 'https://developers.cloudflare.com/version-management/changelog/'
translation_source_md: 'https://developers.cloudflare.com/version-management/changelog/index.md'
