...
translation_source_html: 'https://developers.cloudflare.com/hyperdrive/platform/release-notes/'
translation_source_md: 'https://developers.cloudflare.com/hyperdrive/platform/release-notes/index.md'
