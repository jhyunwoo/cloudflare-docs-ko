---
title: http.request.body.raw · Cloudflare Ruleset 엔진 docs
description: unaltered HTTP 요구 몸.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.raw/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.raw/index.md
...
`http.request.body.raw`스트레이트

unaltered HTTP 요구 몸.

값이 있을 때[`http.request.body.truncated`](https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.truncated/)이름 \*`true`, 반환 값은 truncated 일 수 있습니다.
