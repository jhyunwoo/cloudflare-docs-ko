---
title: http.request.body.mime · Cloudflare Ruleset 엔진 docs
description: 요청 몸에서 검출되는 MIME 유형.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.mime/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.mime/index.md
...
`http.request.body.mime`스트레이트

요청 몸에서 검출되는 MIME 유형.

다음 일반 카테고리의 가장 일반적인 MIME 유형 지원 : 비디오, 오디오, 이미지, 응용 프로그램, 텍스트.
