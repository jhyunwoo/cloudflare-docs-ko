---
title: http.request.body.multipart.names · Cloudflare 규칙 세트 엔진 docs
description: multipart 몸의 모든 부분에 대 한 복수 이름의 목록.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.names/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.names/index.md
...
---
# http\://www\.request.body.multipart.names 의 이메일 주소

`http.request.body.multipart.names`배열\<Array\<String>>

multipart 몸의 모든 부분에 대 한 복수 이름의 목록.
