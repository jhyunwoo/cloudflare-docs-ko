---
title: >-
  http.request.body.multipart.content transfer encodings · Cloudflare Ruleset 엔진
  docs
description: '`Content-Transfer-Encoding` 머리의 목록은 multipart 몸에 있는 각 부분을 위해.'
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.content_transfer_encodings/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.content_transfer_encodings/index.md
...
---
# http\://www\.request.body.multipart.content transfer encodings

`http.request.body.multipart.content_transfer_encodings`배열\<Array\<String>>

이름 \*`Content-Transfer-Encoding`multipart 몸에 있는 각 부분을 위한 우두머리.
