---
title: http.request.body.multipart · Cloudflare Ruleset 엔진 docs
description: A Map (또는 associative array) 요청 신체의 multipart 값에 복수 이름의 표현.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart/index.md
...
`http.request.body.multipart`지도\<Array\<String>>

A Map (또는 associative array) 요청 신체의 multipart 값에 복수 이름의 표현.
