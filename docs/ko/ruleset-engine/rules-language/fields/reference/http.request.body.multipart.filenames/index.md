---
title: http.request.body.multipart.filenames · Cloudflare 규칙 세트 엔진 docs
description: multipart 몸의 각 부분에 대한 파일명 목록.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.filenames/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.filenames/index.md
...
---
# http.request.body.multipart.파일명

`http.request.body.multipart.filenames`배열\<Array\<String>>

multipart 몸의 각 부분에 대한 파일명 목록.
