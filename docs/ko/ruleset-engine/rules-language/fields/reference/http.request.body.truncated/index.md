---
title: http.request.body.truncated · Cloudflare Ruleset 엔진 docs
description: HTTP 요청 몸이 truncated 여부를 나타냅니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.truncated/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.truncated/index.md
...
`http.request.body.truncated`스낵 바

HTTP 요청 몸이 truncated 여부를 나타냅니다.

시간 :`true`, `http.request.body.*`필드는 HTTP 요청 신체의 모든 포함 할 수 없습니다.
