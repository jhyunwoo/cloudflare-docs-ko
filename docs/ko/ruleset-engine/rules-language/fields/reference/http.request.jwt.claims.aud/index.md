---
title: http.request.jwt.claims.aud · Cloudflare Ruleset 엔진 docs
description: '`aud`(오디언스)는 JSON Web Token(JWT)이 의도한 수신자를 식별합니다.'
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.jwt.claims.aud/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.jwt.claims.aud/index.md
...
---
# http\://www\.request.jwt.claims.aud(으)로

`http.request.jwt.claims.aud`지도\<Array\<String>>
