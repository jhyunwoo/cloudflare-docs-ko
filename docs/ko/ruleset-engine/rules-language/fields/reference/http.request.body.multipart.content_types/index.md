---
title: 'http://www.request.body.multipart.content types · Cloudflare Ruleset 엔진 docs'
description: '`Content-Type` 머리의 목록은 multipart 몸에 있는 각 부분을 위해.'
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.content_types/
  md: >-
    https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/http.request.body.multipart.content_types/index.md
...
---
# http\://www\.request.body.multipart.content types.com/

`http.request.body.multipart.content_types`배열\<Array\<String>>

이름 \*`Content-Type`multipart 몸에 있는 각 부분을 위한 우두머리.
