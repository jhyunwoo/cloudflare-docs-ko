...
head:
  - tag: title
    content: 사용 가능한 필드와 기능 | 응답 헤더 트랜스폼 규칙
...
HTTP 응답 헤더 값을 설정할 때 사용 가능한 필드는 다음과 같습니다.

<Render file="transform/header-modification-fields" product="rules" params={{ location: "response" }} />
