...
translation_source_html: 'https://developers.cloudflare.com/page-shield/release-notes/'
translation_source_md: 'https://developers.cloudflare.com/page-shield/release-notes/index.md'
