...
translation_source_html: 'https://developers.cloudflare.com/logs/changelog/logs/'
translation_source_md: 'https://developers.cloudflare.com/logs/changelog/logs/index.md'
