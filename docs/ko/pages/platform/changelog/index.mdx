...
translation_source_html: 'https://developers.cloudflare.com/pages/platform/changelog/'
translation_source_md: 'https://developers.cloudflare.com/pages/platform/changelog/index.md'
