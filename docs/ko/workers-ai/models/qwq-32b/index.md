---
title: qwq-32b · Cloudflare Workers AI 문서
description: >-
  QwQ는 Qwen 시리즈의 이유 모형입니다. 기존의 교육 조정 모델과 비교, QwQ, 생각과 이유가 가능한, 특히 어려운 문제의 다운 스트림
  작업에서 크게 향상된 성능을 얻을 수 있습니다. QwQ-32B는 주관하는 모형, 예를들면, DeepSeek-R1, o1-mini에 대하여
  경쟁 성과를 달성할 수 있는 중간 크기 이유 모형입니다.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/qwq-32b/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/qwq-32b/index.md'
...
QwQ는 Qwen 시리즈의 이유 모형입니다. 기존의 교육 조정 모델과 비교, QwQ, 생각과 이유가 가능한, 특히 어려운 문제의 다운 스트림 작업에서 크게 향상된 성능을 얻을 수 있습니다. QwQ-32B는 주관하는 모형, 예를들면, DeepSeek-R1, o1-mini에 대하여 경쟁 성과를 달성할 수 있는 중간 크기 이유 모형입니다.

| 모델 정보                                                               |                                  |
| ------------------------------------------------------------------- | -------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 24,000 토큰                        |
| 로라                                                                  | 이름 \*                            |
| 단위 가격                                                               | M 입력 토큰 당 $0.66, M 출력 토큰 당 $1.00 |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwq-32b)
...
- `0`기타 제품
  ...
  - `temperature`수 기본 0.15 분 0 최대 5
...
- `1`기타 제품
  ...
  - `guided_json`기타 제품
    ...
    JSON schema는 응답을 위해 fufilled해야합니다.
