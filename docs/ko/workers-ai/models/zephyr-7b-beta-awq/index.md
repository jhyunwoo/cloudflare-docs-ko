...
description: >-
  Zephyr 7B Beta AWQ는 능률적이고, 정확하고 blazing-fast 낮은 비트 무게 quantized Zephyr 모형
  변종입니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/zephyr-7b-beta-awq/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/zephyr-7b-beta-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/zephyr-7b-beta-awq/'
...
# zephyr-7b-beta-awq 베타

텍스트 생성 • thebloke

@hf/thebloke/zephyr-7b-beta-awq

Zephyr 7B Beta AWQ는 능률적이고, 정확하고 blazing-fast 낮은 비트 무게 quantized Zephyr 모형 변종입니다.

| 모델 정보                                                               |                                                             |
| ------------------------------------------------------------------- | ----------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                   |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                    |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/TheBloke/zephyr-7B-beta-AWQ) |
| 베타 베타                                                               | 이름 \*                                                       |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/zephyr-7b-beta-awq)
