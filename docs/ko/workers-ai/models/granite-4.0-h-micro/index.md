---
title: 화강암 4.0-h 마이크로 · Cloudflare Workers AI docs
description: >-
  화강암 4.0 Instruct 모형은 벤치 마크의 맞은편에 강한 성과를 전달하고, 중요한 대리인 작업에 있는 기업 주요한 결과를 뒤에 오는
  기능 호출하. 이 효율성은 Retrieval-augmented Generation (RAG), 멀티 시약 워크플로우 및 Edge 배포와 같은
  다양한 사용 사례에 잘 맞는 모델을 만듭니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/granite-4.0-h-micro/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/granite-4.0-h-micro/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/granite-4.0-h-micro/'
...
---
![IBM 로고](https://developers.cloudflare.com/_astro/ibm.Bqbnu_R0.svg)

# 화강암 4.0-h 마이크로

텍스트 생성 • IBM

@cf/ibm-granite/granite-4.0-h 마이크로

화강암 4.0 Instruct 모형은 벤치 마크의 맞은편에 강한 성과를 전달하고, 중요한 대리인 작업에 있는 기업 주요한 결과를 뒤에 오는 기능 호출하. 이 효율성은 Retrieval-augmented Generation (RAG), 멀티 시약 워크플로우 및 Edge 배포와 같은 다양한 사용 사례에 잘 맞는 모델을 만듭니다.

| 모델 정보                                                                  |                                   |
| ---------------------------------------------------------------------- | --------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/)    | 131,000 토큰                        |
| 기능 호출[](https://developers.cloudflare.com/workers-ai/function-calling) | 이름 \*                             |
| 단위 가격                                                                  | M 입력 토큰 당 $0.017, M 출력 토큰 당 $0.11 |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/ibm-granite/granite-4.0-h-micro)
