---
title: qwen3-30b-a3b-fp8 · Cloudflare Workers AI docs
description: >-
  Qwen3는 Qwen 시리즈에서 큰 언어 모델의 최신 세대이며, dense 및 혼합물 -of-experts (MoE) 모델의 포괄적 인
  스위트를 제공합니다. 광대한 훈련에 건축하는, Qwen3는 이유에 있는 획기적인 전진을, 지시 따기, 대리인 기능 및 다언어 지원을
  전달합니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/qwen3-30b-a3b-fp8/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/qwen3-30b-a3b-fp8/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/qwen3-30b-a3b-fp8/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/qwen3-30b-a3b-fp8/index.md'
...
@cf/qwen/qwen3-30b-a3b-fp8에

Qwen3는 Qwen 시리즈에서 큰 언어 모델의 최신 세대이며, dense 및 혼합물 -of-experts (MoE) 모델의 포괄적 인 스위트를 제공합니다. 광대한 훈련에 건축하는, Qwen3는 이유에 있는 획기적인 전진을, 지시 따기, 대리인 기능 및 다언어 지원을 전달합니다.

| 모델 정보                                                                  |                                   |
| ---------------------------------------------------------------------- | --------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/)    | 32,768 토큰                         |
| 기능 호출[](https://developers.cloudflare.com/workers-ai/function-calling) | 이름 \*                             |
| 공지사항                                                                   | 이름 \*                             |
| 단위 가격                                                                  | M 입력 토큰 당 $0.051, M 출력 토큰 당 $0.34 |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwen3-30b-a3b-fp8)
  ...
  - `choices`지원하다
    ...
    - `items`기타 제품
      ...
      - `message`기타 제품
        ...
        - `reasoning_content`이름 \*

          내부 감응작용 내용 (사용 가능한 경우)
