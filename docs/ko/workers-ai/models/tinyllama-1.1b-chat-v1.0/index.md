...
description: >-
  TinyLlama 프로젝트는 3 조 토큰의 1.1B Llama 모델을 미리 훈련하는 것을 목표로합니다. 이것은
  TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T의 정상에 걸린 채팅 모델입니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/tinyllama-1.1b-chat-v1.0/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/tinyllama-1.1b-chat-v1.0/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/tinyllama-1.1b-chat-v1.0/'
...
# tinyllama-1.1b-chat-v1.0 베타

텍스트 생성 • tinyllama

@cf/tinyllama/tinyllama-1.1b-chat-v1.0

TinyLlama 프로젝트는 3 조 토큰의 1.1B Llama 모델을 미리 훈련하는 것을 목표로합니다. 이것은 TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T의 정상에 걸린 채팅 모델입니다.

| 모델 정보                                                               |                                                                    |
| ------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 인기 있는                                                               | 10/1/2025                                                          |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 2,048 토큰                                                           |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/TinyLlama/TinyLlama-1.1B-Chat-v1.0) |
| 베타 베타                                                               | 이름 \*                                                              |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/tinyllama/tinyllama-1.1b-chat-v1.0)
