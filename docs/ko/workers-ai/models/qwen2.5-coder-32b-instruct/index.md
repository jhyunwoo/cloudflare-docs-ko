...
description: >-
  Qwen2.5-Coder는 CodeQwen의 최신 시리즈입니다. 현재 Qwen2.5-Coder는 다른 개발자의 요구를 충족시키기 위해 6
  개의 주류 모델 크기, 0.5, 1.5, 3, 7, 14, 32 억 매개 변수를 덮었습니다. Qwen2.5-Coder는
  CodeQwen1.5에 뒤에 오는 개선을 가져옵니다:
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/qwen2.5-coder-32b-instruct/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/qwen2.5-coder-32b-instruct/index.md
...
# qwen2.5-coder-32b 구조

텍스트 생성 • Qwen

@cf/qwen/qwen2.5-coder-32b 구조

Qwen2.5-Coder는 CodeQwen의 최신 시리즈입니다. 현재 Qwen2.5-Coder는 다른 개발자의 요구를 충족시키기 위해 6 개의 주류 모델 크기, 0.5, 1.5, 3, 7, 14, 32 억 매개 변수를 덮었습니다. Qwen2.5-Coder는 CodeQwen1.5에 뒤에 오는 개선을 가져옵니다:
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwen2.5-coder-32b-instruct)
