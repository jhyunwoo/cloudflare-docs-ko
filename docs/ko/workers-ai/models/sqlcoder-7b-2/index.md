---
title: sqlcoder-7b-2 · Cloudflare Workers AI 문서
description: 이 모델은 SQL 데이터베이스 내에서 데이터를 이해하기 위해 비 기술 사용자에 의해 사용될 것입니다.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/sqlcoder-7b-2/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/sqlcoder-7b-2/index.md'
...
@cf/defog/sqlcoder-7b-2에

이 모델은 SQL 데이터베이스 내에서 데이터를 이해하기 위해 비 기술 사용자에 의해 사용될 것입니다.

| 모델 정보                                                               |                                                                 |
| ------------------------------------------------------------------- | --------------------------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 10,000 토큰                                                       |
| 이용 약관                                                               | [이름 \*](https://creativecommons.org/licenses/by-sa/4.0/deed.en) |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/defog/sqlcoder-7b-2)             |
| 베타 베타                                                               | 이름 \*                                                           |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/defog/sqlcoder-7b-2)
