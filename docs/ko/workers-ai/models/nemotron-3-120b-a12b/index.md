---
title: nemotron-3-120b-a12b · Cloudflare Workers AI docs
description: >-
  NVIDIA Nemotron 3 Super는 멀티 시약 애플리케이션 및 전문 에이전트 AI 시스템에 대한 주요 정확도를 가진 하이브리드
  MoE 모델입니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/nemotron-3-120b-a12b/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/nemotron-3-120b-a12b/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/nemotron-3-120b-a12b/'
...
@cf/nvidia/nemotron-3-120b-a12b의

NVIDIA Nemotron 3 Super는 멀티 시약 애플리케이션 및 전문 에이전트 AI 시스템에 대한 주요 정확도를 가진 하이브리드 MoE 모델입니다.

| 모델 정보                                                                  |                                                                                                          |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/)    | 32,000 토큰                                                                                                |
| 이용 약관                                                                  | [이름 \*](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-nemotron-open-model-license/) |
| 기능 호출[](https://developers.cloudflare.com/workers-ai/function-calling) | 이름 \*                                                                                                    |
| 단위 가격                                                                  | M 입력 토큰 당 $0.50, M 출력 토큰 당 $1.50                                                                         |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/nvidia/nemotron-3-120b-a12b)
