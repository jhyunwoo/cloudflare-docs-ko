---
title: qwen1.5-14b-chat-awq · Cloudflare Workers AIQ docs
description: >-
  Qwen1.5는 Qwen의 개량한 버전, Alibaba Cloud에 의해 개발된 큰 언어 모형 시리즈입니다. AWQ는 능률 적이고, 정확하고
  blazing-fast 낮 비트 무게 quantization 방법, 현재 4 비트 quantization를 지원하.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/qwen1.5-14b-chat-awq/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/qwen1.5-14b-chat-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/qwen1.5-14b-chat-awq/'
...
# qwen1.5-14b-chat-awq 베타

텍스트 생성 • Qwen

@cf/qwen/qwen1.5-14b-chat-awq

Qwen1.5는 Qwen의 개량한 버전, Alibaba Cloud에 의해 개발된 큰 언어 모형 시리즈입니다. AWQ는 능률 적이고, 정확하고 blazing-fast 낮 비트 무게 quantization 방법, 현재 4 비트 quantization를 지원하.

| 모델 정보                                                               |                                                           |
| ------------------------------------------------------------------- | --------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                 |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 7,500 토큰                                                  |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/qwen/qwen1.5-14b-chat-awq) |
| 베타 베타                                                               | 이름 \*                                                     |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwen1.5-14b-chat-awq)
