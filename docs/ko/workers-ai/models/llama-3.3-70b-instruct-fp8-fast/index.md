...
description: 'Llama 3.3 70B는 FP8 정밀도에, 더 빠르게 낙관했습니다.'
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3.3-70b-instruct-fp8-fast/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3.3-70b-instruct-fp8-fast/index.md
...
# llama-3.3-70b-instruct-fp8-빠른

텍스트 생성 • 메타

@cf/meta/llama-3.3-70b-instruct-fp8-빠른

Llama 3.3 70B는 FP8 정밀도에, 더 빠르게 낙관했습니다.

| 모델 정보                                                                  |                                                                                       |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/)    | 24,000 토큰                                                                             |
| 이용 약관                                                                  | [이름 \*](https://github.com/meta-llama/llama-models/blob/main/models/llama3_3/LICENSE) |
| 기능 호출[](https://developers.cloudflare.com/workers-ai/function-calling) | 이름 \*                                                                                 |
| 공지사항                                                                   | 이름 \*                                                                                 |
| 단위 가격                                                                  | M 입력 토큰 당 $0.29, M 출력 토큰 당 $2.25                                                      |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3.3-70b-instruct-fp8-fast)
...
- `2`기타 제품
  ...
  - `requests`지원하다
    ...
    - `items`기타 제품
      ...
      - `external_reference`이름 \*

        사용자 공급 reference. 이 분야는 응답에서 선물될 것입니다 뿐 아니라 그것은 reference에 요구로 사용될 수 있고 응답. 그것은 독특하지 않다.

      - `prompt`문자열 분 1

        텍스트 생성 모델에 대한 Prompt
