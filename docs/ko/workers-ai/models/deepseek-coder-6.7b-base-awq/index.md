...
description: >-
  Deepseek Coder는 일련의 코드 언어 모델로 구성되어 있으며, 각각은 2T 토큰에 스크래치에서 훈련되어 87% 코드와 13% 모두
  영어 및 중국어로 자연 언어를 구성합니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/deepseek-coder-6.7b-base-awq/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/deepseek-coder-6.7b-base-awq/index.md
...
# deepseek-coder-6.7b-base-awq 베타

텍스트 생성 • thebloke

@hf/thebloke/deepseek-coder-6.7b 기초 awq

Deepseek Coder는 일련의 코드 언어 모델로 구성되어 있으며, 각각은 2T 토큰에 스크래치에서 훈련되어 87% 코드와 13% 모두 영어 및 중국어로 자연 언어를 구성합니다.

| 모델 정보                                                               |                                                                       |
| ------------------------------------------------------------------- | --------------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                             |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                              |
| 이용 약관                                                               | [이름 \*](https://huggingface.co/TheBloke/deepseek-coder-6.7B-base-AWQ) |
| 베타 베타                                                               | 이름 \*                                                                 |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/deepseek-coder-6.7b-base-awq)
