...
description: >-
  OpenHermes 2.5 Mistral 7B는 추가 코드 데이터셋에 훈련되는 OpenHermes 2 모델의 연속적인 예술 미스트랄
  Fine-tune의 상태입니다.
...
source_url:
  ...
  md: >-
    https://developers.cloudflare.com/workers-ai/models/openhermes-2.5-mistral-7b-awq/index.md
...
# openhermes-2.5-mistral-7b-awq 베타

텍스트 생성 • thebloke

@hf/thebloke/openhermes-2.5-mistral-7b-awq

OpenHermes 2.5 Mistral 7B는 추가 코드 데이터셋에 훈련되는 OpenHermes 2 모델의 연속적인 예술 미스트랄 Fine-tune의 상태입니다.
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/openhermes-2.5-mistral-7b-awq)
