---
title: 미들럴-7b-instruct-v0.1-awq · Cloudflare Workers AI docs
description: >-
  Mistral 7B Instruct v0.1 AWQ는 능률 적이고, 정확하고 blazing-fast 낮은 비트 무게 quantized
  Mistral 변종입니다.
...
source_url:
  ...
  md: >-
    https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.1-awq/index.md
...
# mistral-7b-instruct-v0.1-awq 베타

텍스트 생성 • thebloke

@hf/thebloke/mistral-7b-instruct-v0.1-awq

Mistral 7B Instruct v0.1 AWQ는 능률 적이고, 정확하고 blazing-fast 낮은 비트 무게 quantized Mistral 변종입니다.

| 모델 정보                                                               |                                                                       |
| ------------------------------------------------------------------- | --------------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                             |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                              |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/TheBloke/Mistral-7B-Instruct-v0.1-AWQ) |
| 베타 베타                                                               | 이름 \*                                                                 |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/mistral-7b-instruct-v0.1-awq)
