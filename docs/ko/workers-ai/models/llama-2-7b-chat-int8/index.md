...
description: Quantized (int8) Meta에서 7 억 매개 변수를 가진 유전 텍스트 모델
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-int8/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-int8/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-int8/'
...
# llama-2-7b-chat-int8에

텍스트 생성 • 메타

@cf/meta/llama-2-7b-chat-int8에

Quantized (int8) Meta에서 7 억 매개 변수를 가진 유전 텍스트 모델
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-2-7b-chat-int8)
