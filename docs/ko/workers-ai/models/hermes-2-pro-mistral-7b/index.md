---
title: mymes-2-pro-mistral-7b · Cloudflare Workers AI docs
description: >-
  Hermes 2 Pro on Mistral 7B는 새로운 주력 7B 헤르메스입니다! Hermes 2 Pro는 OpenHermes 2.5
  Dataset의 업데이트 및 정리 된 버전으로 구성된 Nous Hermes 2 버전뿐만 아니라 새로 도입 된 기능 Calling 및 JSON
  모드 데이터셋이 사내 개발되었습니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/hermes-2-pro-mistral-7b/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/hermes-2-pro-mistral-7b/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/hermes-2-pro-mistral-7b/'
...
# Hermes-2-pro-mistral-7b 베타

텍스트 생성 • nousresearch

@hf/nousresearch/hermes-2-pro-mistral-7b

Hermes 2 Pro on Mistral 7B는 새로운 주력 7B 헤르메스입니다! Hermes 2 Pro는 OpenHermes 2.5 Dataset의 업데이트 및 정리 된 버전으로 구성된 Nous Hermes 2 버전뿐만 아니라 새로 도입 된 기능 Calling 및 JSON 모드 데이터셋이 사내 개발되었습니다.

| 모델 정보                                                                  |                                                                      |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/)    | 24,000 토큰                                                            |
| 더 많은 정보                                                                | [이름 \*](https://huggingface.co/NousResearch/Hermes-2-Pro-Mistral-7B) |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/nousresearch/hermes-2-pro-mistral-7b)
