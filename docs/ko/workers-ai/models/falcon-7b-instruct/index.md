---
title: falcon-7b-instruct · Cloudflare Workers AI 문서
description: >-
  Falcon-7B-Instruct는 Falcon-7B에 근거를 둔 TII에 의해 건설된 7B 모수 외상 암호해독기 전용 모형이고 잡담/구조물
  데이터셋의 혼합물에 절정했습니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/falcon-7b-instruct/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/falcon-7b-instruct/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/falcon-7b-instruct/'
...
# falcon-7b-instruct 베타

텍스트 생성 • tiiuae

@cf/tiiuae/falcon-7b 구조

Falcon-7B-Instruct는 Falcon-7B에 근거를 둔 TII에 의해 건설된 7B 모수 외상 암호해독기 전용 모형이고 잡담/구조물 데이터셋의 혼합물에 절정했습니다.

| 모델 정보                                                               |                                                           |
| ------------------------------------------------------------------- | --------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                 |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                  |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/tiiuae/falcon-7b-instruct) |
| 베타 베타                                                               | 이름 \*                                                     |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/tiiuae/falcon-7b-instruct)
