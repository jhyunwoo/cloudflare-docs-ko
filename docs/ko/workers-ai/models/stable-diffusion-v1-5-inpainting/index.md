---
title: 안정 확산-v1-5-inpainting · Cloudflare Workers AI docs
description: 안정된 확산 Inpainting은 마스크를 사용하여 사진 생성을 할 수있는 늦은 텍스트 투 이미지 확산 모델입니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-v1-5-inpainting/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-v1-5-inpainting/index.md
...
# 안정 확산 V1-5-inpainting 베타

텍스트 이미지 • runwayml

@cf/runwayml/stable-diffusion-v1-5-inpainting

안정된 확산 Inpainting은 마스크를 사용하여 사진 생성을 할 수있는 늦은 텍스트 투 이미지 확산 모델입니다.

| 모델 정보   |                                                                         |
| ------- | ----------------------------------------------------------------------- |
| 이용 약관   | [이름 \*](https://github.com/runwayml/stable-diffusion/blob/main/LICENSE) |
| 더 많은 정보 | [이름 \*](https://huggingface.co/runwayml/stable-diffusion-inpainting)    |
| 베타 베타   | 이름 \*                                                                   |
| 단위 가격   | 단계 당 $0.00                                                              |
