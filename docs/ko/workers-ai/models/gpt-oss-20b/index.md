---
title: gpt-oss-20b · Cloudflare Workers AI 문서
description: >-
  OpenAI의 강력한 소싱, 에이전트 작업 및 다양한 개발자 사용 사례를 위해 설계된 개방 중량 모델 – gpt-oss-20b는 낮은 대기
  시간 및 지역 또는 특수 사용 케이스에 사용됩니다.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gpt-oss-20b/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/gpt-oss-20b/index.md'
...
@cf/openai/gpt-oss-20b에

OpenAI의 강력한 소싱, 에이전트 작업 및 다양한 개발자 사용 사례를 위해 설계된 개방 중량 모델 – gpt-oss-20b는 낮은 대기 시간 및 지역 또는 특수 사용 케이스에 사용됩니다.

| 모델 정보                                                               |                                  |
| ------------------------------------------------------------------- | -------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 128,000 토큰                       |
| 단위 가격                                                               | M 입력 토큰 당 $0.20, M 출력 토큰 당 $0.30 |
...
- **Workers AI 지원하다** (`/ai/run`) - 동적인 체재 탐지는, 채팅 보상을 받아들입니다 (`messages`), 유산 보상 (`prompt`), 또는 응답 API (`input`)
