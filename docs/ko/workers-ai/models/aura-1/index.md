---
title: aura-1 · Cloudflare Workers AI docs
description: >-
  Aura는 제공된 텍스트의 컨텍스트를 기반으로 한 천연 파싱, 표현성, 필러를 적용하는 컨텍스트-aware text-to-speech
  (TTS) 모델입니다. 텍스트 입력의 품질은 직접 오디오 출력의 자연스러운 영향을줍니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/aura-1/'
  md: 'https://developers.cloudflare.com/workers-ai/models/aura-1/index.md'
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/aura-1/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/aura-1/index.md'
...
Aura는 제공된 텍스트의 컨텍스트를 기반으로 한 천연 파싱, 표현성, 필러를 적용하는 컨텍스트-aware text-to-speech (TTS) 모델입니다. 텍스트 입력의 품질은 직접 오디오 출력의 자연스러운 영향을줍니다.
