...
description: Llama 3.1 8B는 FP8 정밀도에 quantized
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3.1-8b-instruct-fp8/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3.1-8b-instruct-fp8/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-3.1-8b-instruct-fp8/'
...
# llama-3.1-8b 구조 SFP8

텍스트 생성 • 메타

@cf/meta/llama-3.1-8b-instruct-fp8에

Llama 3.1 8B는 FP8 정밀도에 quantized
...
| 단위 가격                                                               | M 입력 토큰 당 $0.15, M 출력 토큰 당 $0.29                                                      |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3.1-8b-instruct-fp8)
