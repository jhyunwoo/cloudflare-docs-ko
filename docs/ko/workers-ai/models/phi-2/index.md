...
description: >-
  Phi-2는 NLP 및 코딩을위한 합성 및 웹 데이터 세트의 혼합물에서 1.4T 토큰에 훈련 된 차세대 예측 목표를 가진 변압기 기반
  모델입니다.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/phi-2/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/phi-2/index.md'
...
Phi-2는 NLP 및 코딩을위한 합성 및 웹 데이터 세트의 혼합물에서 1.4T 토큰에 훈련 된 차세대 예측 목표를 가진 변압기 기반 모델입니다.

| 모델 정보                                                               |                                                 |
| ------------------------------------------------------------------- | ----------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 2,048 토큰                                        |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/microsoft/phi-2) |
| 베타 베타                                                               | 이름 \*                                           |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/microsoft/phi-2)
