---
title: openchat-3.5-0106 · Cloudflare Workers AI 문서
description: 'OpenChat은 오픈 소스 언어 모델의 혁신적인 라이브러리이며, C-RLFT로 잘 조정되어 오프라인 보강 학습에 영감을 주는 전략입니다.'
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/openchat-3.5-0106/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/openchat-3.5-0106/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/openchat-3.5-0106/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/openchat-3.5-0106/index.md'
...
# openchat-3.5-0106 베타

텍스트 생성 • openchat

@cf/openchat/openchat-3.5-0106에

OpenChat은 오픈 소스 언어 모델의 혁신적인 라이브러리이며, C-RLFT로 잘 조정되어 오프라인 보강 학습에 영감을 주는 전략입니다.

| 모델 정보                                                               |                                                            |
| ------------------------------------------------------------------- | ---------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                  |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 8,192 토큰                                                   |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/openchat/openchat-3.5-0106) |
| 베타 베타                                                               | 이름 \*                                                      |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/openchat/openchat-3.5-0106)
