---
title: Dreamshaper-8-lcm · Cloudflare Workers AI 문서
description: 안정적인 Diffusion 모델은 희생 범위없이 photorealism에서 더 잘 될 수 있습니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/dreamshaper-8-lcm/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/dreamshaper-8-lcm/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/dreamshaper-8-lcm/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/dreamshaper-8-lcm/index.md'
...
@cf/lykon/dreamshaper-8-lcm에

안정적인 Diffusion 모델은 희생 범위없이 photorealism에서 더 잘 될 수 있습니다.

| 모델 정보   |                                                   |
| ------- | ------------------------------------------------- |
| 더 많은 정보 | [이름 \*](https://huggingface.co/Lykon/DreamShaper) |
