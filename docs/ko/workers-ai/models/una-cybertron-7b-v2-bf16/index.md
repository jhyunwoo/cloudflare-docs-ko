...
description: >-
  Cybertron 7B v2는 7B MistralAI에 근거한 모형, 시리즈에 베스트입니다. 그것은 여러 데이터 세트에 SFT, DPO 및
  UNA (Unified Neural Alignment)로 훈련되었습니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/una-cybertron-7b-v2-bf16/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/una-cybertron-7b-v2-bf16/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/una-cybertron-7b-v2-bf16/'
...
# una-cybertron-7b-v2-bf16 베타

텍스트 생성 • fblgit

@cf/fblgit/나-cybertron-7b-v2-bf16

Cybertron 7B v2는 7B MistralAI에 근거한 모형, 시리즈에 베스트입니다. 그것은 여러 데이터 세트에 SFT, DPO 및 UNA (Unified Neural Alignment)로 훈련되었습니다.

| 모델 정보                                                               |           |
| ------------------------------------------------------------------- | --------- |
| 인기 있는                                                               | 10/1/2025 |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 15,000 토큰 |
| 베타 베타                                                               | 이름 \*     |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/fblgit/una-cybertron-7b-v2-bf16)
