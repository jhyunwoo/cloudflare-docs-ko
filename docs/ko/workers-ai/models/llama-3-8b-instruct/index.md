...
description: 세대에 Meta Llama 3는 다양한 산업 벤치 마크에 최첨단 성능을 보여 주며 향상된 이유를 포함하여 새로운 기능을 제공합니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct/'
...
@cf/meta/llama-3-8b 구조

세대에 Meta Llama 3는 다양한 산업 벤치 마크에 최첨단 성능을 보여 주며 향상된 이유를 포함하여 새로운 기능을 제공합니다.

| 모델 정보                                                               |                                                  |
| ------------------------------------------------------------------- | ------------------------------------------------ |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 7,968 토큰                                         |
| 이용 약관                                                               | [이름 \*](https://llama.meta.com/llama3/license/#) |
| 더 많은 정보                                                             | [이름 \*](https://llama.meta.com)                  |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3-8b-instruct)
