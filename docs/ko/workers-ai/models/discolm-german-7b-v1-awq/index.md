---
title: 디스크램 - 거만 - 7b-v1-awq · Cloudflare Workers AI docs
description: >-
  DiscoLM German 7b는 독일 언어 응용 분야에 중점을 둔 Mistral 기반 대형 언어 모델입니다. AWQ는 능률 적이고,
  정확하고 blazing-fast 낮 비트 무게 quantization 방법, 현재 4 비트 quantization를 지원하.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/discolm-german-7b-v1-awq/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/discolm-german-7b-v1-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/discolm-german-7b-v1-awq/'
...
# discolm-german-7b-v1-awq 베타

텍스트 생성 • thebloke

@cf/thebloke/discolm-german-7b-v1-awq

DiscoLM German 7b는 독일 언어 응용 분야에 중점을 둔 Mistral 기반 대형 언어 모델입니다. AWQ는 능률 적이고, 정확하고 blazing-fast 낮 비트 무게 quantization 방법, 현재 4 비트 quantization를 지원하.

| 모델 정보                                                               |                                                                   |
| ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                         |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                          |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/TheBloke/DiscoLM_German_7b_v1-AWQ) |
| 베타 베타                                                               | 이름 \*                                                             |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/thebloke/discolm-german-7b-v1-awq)
