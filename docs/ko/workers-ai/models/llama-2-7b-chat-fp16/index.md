...
description: 전체 정밀도 (FP16) Meta에서 7 억 매개 변수를 가진 유전 텍스트 모델
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-fp16/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-fp16/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-fp16/'
...
# llama-2-7b-chat-fp16에 관하여

텍스트 생성 • 메타

@cf/meta/llama-2-7b-chat-fp16에

전체 정밀도 (FP16) Meta에서 7 억 매개 변수를 가진 유전 텍스트 모델

| 모델 정보                                                               |                                                                              |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                                     |
| 이용 약관                                                               | [이름 \*](https://ai.meta.com/resources/models-and-libraries/llama-downloads/) |
| 더 많은 정보                                                             | [이름 \*](https://ai.meta.com/llama/)                                          |
| 단위 가격                                                               | M 입력 토큰 당 $0.56, M 출력 토큰 당 $6.67                                             |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-2-7b-chat-fp16)
