---
title: Gemma-7b-it · Cloudflare Workers AI 문서
description: >-
  Gemma는 경량의 가족, Google의 최첨단 오픈 모델, Gemini 모델을 만들기 위해 사용되는 동일한 연구 및 기술에서 내장. 그들은
  텍스트 텍스트 텍스트, 디코더 전용 대형 언어 모델, 영어에서 사용할 수, 열중량, 사전 훈련 된 변형, 및 교육 조정 변형.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gemma-7b-it/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/gemma-7b-it/index.md'
...
@hf/google/gemma-7b-it에

Gemma는 경량의 가족, Google의 최첨단 오픈 모델, Gemini 모델을 만들기 위해 사용되는 동일한 연구 및 기술에서 내장. 그들은 텍스트 텍스트 텍스트, 디코더 전용 대형 언어 모델, 영어에서 사용할 수, 열중량, 사전 훈련 된 변형, 및 교육 조정 변형.

| 모델 정보                                                               |                                            |
| ------------------------------------------------------------------- | ------------------------------------------ |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 8,192 토큰                                   |
| 이용 약관                                                               | [이름 \*](https://ai.google.dev/gemma/terms) |
| 더 많은 정보                                                             | [이름 \*](https://ai.google.dev/gemma/docs)  |
| 로라                                                                  | 이름 \*                                      |
| 베타 베타                                                               | 이름 \*                                      |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/google/gemma-7b-it)
