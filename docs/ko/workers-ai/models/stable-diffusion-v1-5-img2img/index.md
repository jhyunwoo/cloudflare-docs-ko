---
title: 안정 확산-v1-5-img2img · Cloudflare Workers AI docs
description: >-
  Stable Diffusion은 사진 현실적인 이미지를 생성 할 수있는 늦은 텍스트 - 투 이미지 확산 모델입니다. Img2img는 안정적인
  확산과 입력 이미지에서 새로운 이미지를 생성합니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-v1-5-img2img/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-v1-5-img2img/index.md
...
# 안정 확산 V1-5-img2img 베타

텍스트 이미지 • runwayml

@cf/runwayml/stable-diffusion-v1-5-img2img

Stable Diffusion은 사진 현실적인 이미지를 생성 할 수있는 늦은 텍스트 - 투 이미지 확산 모델입니다. Img2img는 안정적인 확산과 입력 이미지에서 새로운 이미지를 생성합니다.

| 모델 정보   |                                                                         |
| ------- | ----------------------------------------------------------------------- |
| 이용 약관   | [이름 \*](https://github.com/runwayml/stable-diffusion/blob/main/LICENSE) |
| 더 많은 정보 | [이름 \*](https://huggingface.co/runwayml/stable-diffusion-v1-5)          |
| 베타 베타   | 이름 \*                                                                   |
| 단위 가격   | 단계 당 $0.00                                                              |
