---
title: bge-large-en-v1.5 · Cloudflare Workers AI 문서
description: BAAI 일반 embedding (Large) 모델은 주어진 텍스트를 1024 차원 벡터로 변환
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/bge-large-en-v1.5/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/bge-large-en-v1.5/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/bge-large-en-v1.5/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/bge-large-en-v1.5/index.md'
...
@cf/baai/bge-큰-en-v1.5

BAAI 일반 embedding (Large) 모델은 주어진 텍스트를 1024 차원 벡터로 변환

| 모델 정보    |                                                        |
| -------- | ------------------------------------------------------ |
| 더 많은 정보  | [이름 \*](https://huggingface.co/BAAI/bge-large-en-v1.5) |
| 최대 입력 토큰 | 512                                                    |
| 산출 차원    | 1,024                                                  |
| 공지사항     | 이름 \*                                                  |
| 단위 가격    | M 입력 토큰 당 $0.20                                        |
