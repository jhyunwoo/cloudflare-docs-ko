...
description: >-
  이것은 Llama2 기본적인 모형입니다 Cloudflare는 LoRA 접합기를 가진 inference를 위해 전념했습니다. Llama 2는
  7 억에서 70 억 매개 변수까지 규모로 배열하는 사전 및 미세 조정 된 유전 텍스트 모델의 컬렉션입니다. 이것은 대화 사용 케이스에 최적화
  된 7B 미세 조정 모델에 대한 저장소이며 Hugging Face Transformers 형식으로 변환됩니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-hf-lora/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-hf-lora/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-hf-lora/'
...
# llama-2-7b-chat-hf-lora 베타

텍스트 생성 • meta-llama

@cf/meta-llama/llama-2-7b-chat-hf-lora

이것은 Llama2 기본적인 모형입니다 Cloudflare는 LoRA 접합기를 가진 inference를 위해 전념했습니다. Llama 2는 7 억에서 70 억 매개 변수까지 규모로 배열하는 사전 및 미세 조정 된 유전 텍스트 모델의 컬렉션입니다. 이것은 대화 사용 케이스에 최적화 된 7B 미세 조정 모델에 대한 저장소이며 Hugging Face Transformers 형식으로 변환됩니다.
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta-llama/llama-2-7b-chat-hf-lora)
