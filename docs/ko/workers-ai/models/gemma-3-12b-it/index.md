---
title: Gemma-3-12b-it · Cloudflare Workers AI 문서
description: >-
  Gemma 3 모델은 다양한 텍스트 생성 및 이미지 이해 작업을 위해 잘 추적됩니다. 질문 답변, 요약 및 이유. Gemma 3 모델은
  다중화, 텍스트 및 이미지 입력 및 텍스트 출력을 생성, 큰, 128K 컨텍스트 창, 140 개 이상의 언어로 다국어 지원, 이전 버전보다
  더 많은 크기에서 사용할 수 있습니다.
...
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gemma-3-12b-it/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/gemma-3-12b-it/index.md'
...
@cf/google/gemma-3-12b-it에

Gemma 3 모델은 다양한 텍스트 생성 및 이미지 이해 작업을 위해 잘 추적됩니다. 질문 답변, 요약 및 이유. Gemma 3 모델은 다중화, 텍스트 및 이미지 입력 및 텍스트 출력을 생성, 큰, 128K 컨텍스트 창, 140 개 이상의 언어로 다국어 지원, 이전 버전보다 더 많은 크기에서 사용할 수 있습니다.

| 모델 정보                                                               |                                  |
| ------------------------------------------------------------------- | -------------------------------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 80,000 토큰                        |
| 로라                                                                  | 이름 \*                            |
| 단위 가격                                                               | M 입력 토큰 당 $0.35, M 출력 토큰 당 $0.56 |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/google/gemma-3-12b-it)
