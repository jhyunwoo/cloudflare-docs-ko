---
title: Gemma-2b-it-lora · Cloudflare Workers AI 문서
description: >-
  이것은 CloudflareXQ가 LoRA 어댑터와 관련하여 의도를 결정하는 Gemma-2B 기본 모델입니다. Gemma는 경량의 가족,
...
source_url:
  ...
  md: >-
    https://developers.cloudflare.com/workers-ai/models/gemma-2b-it-lora/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gemma-2b-it-lora/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/gemma-2b-it-lora/index.md'
...
이것은 CloudflareXQ가 LoRA 어댑터와 관련하여 의도를 결정하는 Gemma-2B 기본 모델입니다. Gemma는 경량의 가족, Google의 최첨단 오픈 모델, Gemini 모델을 만들기 위해 사용되는 동일한 연구 및 기술에서 내장.
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/google/gemma-2b-it-lora)
