---
title: qwen1.5-1.8b-chat · QXQX0194XQ QXWorkers AI docs
description: 'Qwen1.5는 Qwen의 개량한 버전, Alibaba Cloud에 의해 개발된 큰 언어 모형 시리즈입니다.'
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/qwen1.5-1.8b-chat/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/qwen1.5-1.8b-chat/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/qwen1.5-1.8b-chat/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/qwen1.5-1.8b-chat/index.md'
...
# qwen1.5-1.8b-chat 베타

텍스트 생성 • Qwen

@cf/qwen/qwen1.5-1.8b-chat에

Qwen1.5는 Qwen의 개량한 버전, Alibaba Cloud에 의해 개발된 큰 언어 모형 시리즈입니다.

| 모델 정보                                                               |                                                        |
| ------------------------------------------------------------------- | ------------------------------------------------------ |
| 인기 있는                                                               | 10/1/2025                                              |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 32,000 토큰                                              |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/qwen/qwen1.5-1.8b-chat) |
| 베타 베타                                                               | 이름 \*                                                  |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwen1.5-1.8b-chat)
