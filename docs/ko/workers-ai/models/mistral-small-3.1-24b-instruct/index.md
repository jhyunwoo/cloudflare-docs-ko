---
title: '분자 공식: CloudflareQX0208XQXQ'
description: >-
  Mistral Small 3 (2501)에 건물, Mistral Small 3.1 (2503)는 주관적인 시각 이해를 추가하고 텍스트 성능을
  비교하지 않고 128k 토큰까지 긴 컨텍스트 기능을 향상시킵니다. 24 억 매개 변수로이 모델은 텍스트와 비전 작업을 모두에서 최고 수준의
  기능을 달성합니다.
...
source_url:
  ...
  md: >-
    https://developers.cloudflare.com/workers-ai/models/mistral-small-3.1-24b-instruct/index.md
...
# 미들럴-작은-3.1-24b-instruct

텍스트 생성 • MistralAI

@cf/mistralai/mistral-small-3.1-24b 구조

Mistral Small 3 (2501)에 건물, Mistral Small 3.1 (2503)는 주관적인 시각 이해를 추가하고 텍스트 성능을 비교하지 않고 128k 토큰까지 긴 컨텍스트 기능을 향상시킵니다. 24 억 매개 변수로이 모델은 텍스트와 비전 작업을 모두에서 최고 수준의 기능을 달성합니다.
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/mistralai/mistral-small-3.1-24b-instruct)
