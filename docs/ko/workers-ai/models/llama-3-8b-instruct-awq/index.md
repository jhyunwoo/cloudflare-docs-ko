...
description: Quantized (int4) Meta에서 8 억 매개 변수를 가진 유전 텍스트 모델.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct-awq/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct-awq/'
...
Quantized (int4) Meta에서 8 억 매개 변수를 가진 유전 텍스트 모델.
...
| 단위 가격                                                               | M 입력 토큰 당 $0.12, M 출력 토큰 당 $0.27                 |

## 회사연혁

Workers AI LLM 놀이터와 함께이 모델을보십시오. 설정이나 인증이 필요 없으며 즉시 미리 볼 수 있으며 브라우저에서 모델을 직접 테스트 할 수 있습니다.

[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3-8b-instruct-awq)
