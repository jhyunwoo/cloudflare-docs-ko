...
description: |
  Llama Guard는 안전 위험의 세금을 사용하여 LLM 신속하고 응답의 안전을 분류하기위한 모델입니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llamaguard-7b-awq/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llamaguard-7b-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llamaguard-7b-awq/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/llamaguard-7b-awq/index.md'
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/llamaguard-7b-awq)
