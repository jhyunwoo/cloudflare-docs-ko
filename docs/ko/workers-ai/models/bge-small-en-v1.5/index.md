...
description: BAAI 일반 embedding (Small) 모델은 주어진 텍스트를 384 차원 벡터로 변환
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/bge-small-en-v1.5/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/bge-small-en-v1.5/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/bge-small-en-v1.5/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/bge-small-en-v1.5/index.md'
...
@cf/바이/bge-small-en-v1.5

BAAI 일반 embedding (Small) 모델은 주어진 텍스트를 384 차원 벡터로 변환

| 모델 정보    |                                                        |
| -------- | ------------------------------------------------------ |
| 더 많은 정보  | [이름 \*](https://huggingface.co/BAAI/bge-small-en-v1.5) |
| 최대 입력 토큰 | 512                                                    |
| 산출 차원    | 384                                                    |
| 공지사항     | 이름 \*                                                  |
| 단위 가격    | M 입력 토큰 당 $0.02                                        |
  ...
  - `requests`지원되는
    ...
    - `items`기타 제품
      ...
      - `pooling`문자열 기본값은
        ...
        패딩 공정에 사용되는 풀링 방법. \`cls\` 풀링은 더 큰 입력에 더 정확한 embeddings를 생성할 것입니다 - 그러나, cls 풀링으로 창조된 embeddings는 의미있는 풀링으로 생성된 embeddings와 호환이 되지 않습니다. 기본 풀링 방법은 \`mean\`이 끊어지는 변화가 아니라 새로운 \`cls\`XQ 풀링을 사용하여 매우 좋습니다.
