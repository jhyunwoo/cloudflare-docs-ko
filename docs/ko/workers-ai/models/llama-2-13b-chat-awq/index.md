...
description: 라마 2 13B 채팅 AWQ는 효율적이고 정확하며 blazing-fast 낮은 비트 무게의 Llama 2 변종입니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-13b-chat-awq/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/llama-2-13b-chat-awq/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/llama-2-13b-chat-awq/'
...
# llama-2-13b-chat-awq 베타

텍스트 생성 • thebloke

@hf/thebloke/llama-2-13b-chat-awq

라마 2 13B 채팅 AWQ는 효율적이고 정확하며 blazing-fast 낮은 비트 무게의 Llama 2 변종입니다.

| 모델 정보                                                               |                                                               |
| ------------------------------------------------------------------- | ------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                     |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                      |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/TheBloke/Llama-2-13B-chat-AWQ) |
| 베타 베타                                                               | 이름 \*                                                         |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/thebloke/llama-2-13b-chat-awq)
