---
title: 미들레-7b-instruct-v0.2 · Cloudflare Workers AI docs
description: >-
  Mistral-7B-Instruct-v0.2 큰 언어 모델 (LLM)은 Mistral-7B-v0.2의 미세 조정 버전입니다.
  Mistral-7B-v0.2는 Mistral-7B-v0.1 : 32k 컨텍스트 창 (vs 8k 컨텍스트 v0.1), 로프 -theta =
  1e6 및 슬라이딩 -Window주의와 비교하여 다음과 같은 변경 사항이 있습니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.2/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.2/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.2/'
...
# mistral-7b-instruct-v0.2 베타

텍스트 생성 • MistralAI

@hf/mistral/mistral-7b 구조 V0.2

Mistral-7B-Instruct-v0.2 큰 언어 모델 (LLM)은 Mistral-7B-v0.2의 미세 조정 버전입니다. Mistral-7B-v0.2는 Mistral-7B-v0.1 : 32k 컨텍스트 창 (vs 8k 컨텍스트 v0.1), 로프 -theta = 1e6 및 슬라이딩 -Window주의와 비교하여 다음과 같은 변경 사항이 있습니다.

| 모델 정보                                                               |                                                                    |
| ------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 3,072 토큰                                                           |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2) |
| 로라                                                                  | 이름 \*                                                              |
| 베타 베타                                                               | 이름 \*                                                              |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/mistral/mistral-7b-instruct-v0.2)
