...
description: >-
  우리는 AI 피드백 (RLAIF)에서 보강 학습에 의해 훈련 된 Starling-LM-7B-beta를 소개합니다.
  Starling-LM-7B-beta는 Openchat-3.5-0106에서 새로운 보상 모델 Nexusflow/Starling-RM-34B 및
  정책 최적화 방법 Human PreferenceS (PPO)에서 Fine-Tuning 언어 모델로 훈련됩니다.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/starling-lm-7b-beta/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/starling-lm-7b-beta/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/starling-lm-7b-beta/'
...
# starling-lm-7b beta 베타

텍스트 생성 • nexusflow

@hf/nexusflow/스타링-lm-7b-beta

우리는 AI 피드백 (RLAIF)에서 보강 학습에 의해 훈련 된 Starling-LM-7B-beta를 소개합니다. Starling-LM-7B-beta는 Openchat-3.5-0106에서 새로운 보상 모델 Nexusflow/Starling-RM-34B 및 정책 최적화 방법 Human PreferenceS (PPO)에서 Fine-Tuning 언어 모델로 훈련됩니다.

| 모델 정보                                                               |                                                               |
| ------------------------------------------------------------------- | ------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                     |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                      |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/Nexusflow/Starling-LM-7B-beta) |
| 베타 베타                                                               | 이름 \*                                                         |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@hf/nexusflow/starling-lm-7b-beta)
