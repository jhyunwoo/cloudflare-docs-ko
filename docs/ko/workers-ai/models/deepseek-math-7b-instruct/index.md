...
description: >-
  DeepSeekMath-Instruct 7B는 DeepSeekMath-Base 7B에서 파생 된 수학 구조형 튜닝 모델입니다.
  DeepSeekMath는 DeepSeek-Coder-v1.5 7B로 초기화되며 500B 토큰의 천연 언어 및 코드 데이터와 함께 Common
  Crawl의 math-related 토큰에 대한 사전 훈련을 계속합니다.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/deepseek-math-7b-instruct/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/deepseek-math-7b-instruct/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/deepseek-math-7b-instruct/'
...
---
![DeepSeek 로고](https://developers.cloudflare.com/_astro/deepseek.Dn1KbMH4.svg)

# deepseek-math-7b-instruct 베타

텍스트 생성 • DeepSeek

@cf/deepseek-ai/deepseek-math-7b-instruct

DeepSeekMath-Instruct 7B는 DeepSeekMath-Base 7B에서 파생 된 수학 구조형 튜닝 모델입니다. DeepSeekMath는 DeepSeek-Coder-v1.5 7B로 초기화되며 500B 토큰의 천연 언어 및 코드 데이터와 함께 Common Crawl의 math-related 토큰에 대한 사전 훈련을 계속합니다.

| 모델 정보                                                               |                                                                               |
| ------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 인기 있는                                                               | 10/1/2025                                                                     |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 4,096 토큰                                                                      |
| 이용 약관                                                               | [이름 \*](https://github.com/deepseek-ai/DeepSeek-Math/blob/main/LICENSE-MODEL) |
| 더 많은 정보                                                             | [이름 \*](https://huggingface.co/deepseek-ai/deepseek-math-7b-instruct)         |
| 베타 베타                                                               | 이름 \*                                                                         |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/deepseek-ai/deepseek-math-7b-instruct)
