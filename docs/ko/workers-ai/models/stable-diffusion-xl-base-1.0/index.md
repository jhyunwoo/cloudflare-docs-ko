---
title: 안정되어 있는 확산 xl 기초 1.0 · Cloudflare Workers AIQ docs
description: Diffusion-based text-to-image 유전 모델 Stability AI. 텍스트 프롬프트를 기반으로 이미지 생성 및 수정.
chatbotDeprioritize: false
source_url:
  html: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-base-1.0/
  md: >-
    https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-base-1.0/index.md
...
---
![Stability.ai 로고](https://developers.cloudflare.com/_astro/stabilityai.CWXCgVjU.svg)

# 안정된 확산 xl 기초 1.0 베타

텍스트 이미지 • Stability.ai

@cf/stabilityai/stable-diffusion-xl 기초 1.0

Diffusion-based text-to-image 유전 모델 Stability AI. 텍스트 프롬프트를 기반으로 이미지 생성 및 수정.

| 모델 정보   |                                                                                               |
| ------- | --------------------------------------------------------------------------------------------- |
| 이용 약관   | [이름 \*](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/blob/main/LICENSE.md) |
| 더 많은 정보 | [이름 \*](https://stability.ai/stable-diffusion)                                                |
| 베타 베타   | 이름 \*                                                                                         |
| 단위 가격   | 단계 당 $0.00                                                                                    |
