---
title: 보석 바다 사자 v4-27b-it · Cloudflare Workers AI docs
description: >-
  SEA-LION은 동남아시아(SEA)지역을 대상으로 한 대형 언어 모델(LLMs) 컬렉션인 One Network의 동남아시아 언어에 대한
  의미를 담고 있습니다.
...
source_url:
  ...
  md: >-
    https://developers.cloudflare.com/workers-ai/models/gemma-sea-lion-v4-27b-it/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gemma-sea-lion-v4-27b-it/'
...
@cf/aisingapore/gemma 바다 사자 v4-27b-it

SEA-LION은 동남아시아(SEA)지역을 대상으로 한 대형 언어 모델(LLMs) 컬렉션인 One Network의 동남아시아 언어에 대한 의미를 담고 있습니다.
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/aisingapore/gemma-sea-lion-v4-27b-it)
