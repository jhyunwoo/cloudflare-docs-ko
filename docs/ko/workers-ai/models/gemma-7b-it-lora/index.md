...
description: >-
  이것은 CloudflareXQ가 LoRA 어댑터와 관련하여 의도를 결정하는 Gemma-7B 기본 모델입니다. Gemma는 경량의 가족,
  Google의 최첨단 오픈 모델, Gemini 모델을 만들기 위해 사용되는 동일한 연구 및 기술에서 내장.
chatbotDeprioritize: false
source_url:
  html: 'https://developers.cloudflare.com/workers-ai/models/gemma-7b-it-lora/'
  md: >-
    https://developers.cloudflare.com/workers-ai/models/gemma-7b-it-lora/index.md
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/models/gemma-7b-it-lora/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/models/gemma-7b-it-lora/index.md'
...
이것은 CloudflareXQ가 LoRA 접합기를 가진 inference를 위해 토론하는 Gemma-7B 기본적인 모형입니다. Gemma는 경량의 가족, Google의 최첨단 오픈 모델, Gemini 모델을 만들기 위해 사용되는 동일한 연구 및 기술에서 내장.

| 모델 정보                                                               |          |
| ------------------------------------------------------------------- | -------- |
| Context 창[](https://developers.cloudflare.com/workers-ai/glossary/) | 3,500 토큰 |
| 로라                                                                  | 이름 \*    |
| 베타 베타                                                               | 이름 \*    |
...
[LLM 놀이터 출시](https://playground.ai.cloudflare.com/?model=@cf/google/gemma-7b-it-lora)
