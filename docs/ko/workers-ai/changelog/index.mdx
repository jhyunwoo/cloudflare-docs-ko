...
sidebar:
  order: 9
head: []
description: Cloudflare Workers AI에 대한 최근 변경 사항 검토.
translation_locale: ko-KR
translation_source_html: 'https://developers.cloudflare.com/workers-ai/changelog/'
translation_source_md: 'https://developers.cloudflare.com/workers-ai/changelog/index.md'
