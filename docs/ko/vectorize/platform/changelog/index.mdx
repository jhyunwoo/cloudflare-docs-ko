...
translation_source_html: 'https://developers.cloudflare.com/vectorize/platform/changelog/'
translation_source_md: 'https://developers.cloudflare.com/vectorize/platform/changelog/index.md'
